...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_madera.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_madera.xml \
...
# Inherit vendor
$(call inherit-product, vendor/lenovo/sprout/sprout-vendor.mk)